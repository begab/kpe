...
import hu.u_szeged.nlp.pos.KRUtils;
...
public class KRToMSD {
  ...
  public String getPostPLemma(String analysis) {
    ...
    if (analysis.startsWith("$én/NOUN<POSTP<") || analysis.startsWith("$te/NOUN<POSTP<") || analysis.startsWith("$ő/NOUN<POSTP<")
        || analysis.startsWith("$mi/NOUN<POSTP<") || analysis.startsWith("$ti/NOUN<POSTP<") || analysis.startsWith("$ők/NOUN<POSTP<")) {
      String post = null;
    ...
    // $ez/NOUN<POSTP<ELŐTT>>[ATTRIB]/ADJ(-1)(i)<CAS<INS>>
    ...
    if (analysis.startsWith("$ez/NOUN<POSTP<") || analysis.startsWith("$az/NOUN<POSTP<")) {
      ...
      // alá, alatt, alól, által, elé, eléb, ellen, elöl, előtt, iránt, után
      // (pl.: ezután)
      if (analysis.contains("(i)")) {
        if (affix.startsWith("a") || affix.startsWith("á") || affix.startsWith("e") || affix.startsWith("i") || affix.startsWith("u"))
  ...
  public String convertNumber(String kr) {
    StringBuffer msd = null;
  ...
  public Set<MorAna> getMSD(String krAnalysis) {
    ...
    if (krCode.startsWith("ADJ")) {
      ...
      // analisis.add(new Stem(lemma, msd));
      // } else {
